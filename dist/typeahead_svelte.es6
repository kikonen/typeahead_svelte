...
/* src/typeahead.svelte generated by Svelte v3.24.0 */
...
function create_if_block_8(ctx) {
	...
	return {
		c() {
			...
			span = element("span");
			span.textContent = `${/*translate*/ ctx[25]("toggle")}`;
			t1 = space();
			i = element("i");
		...
		m(target, anchor) {
			...
			append(button, t1);
			append(button, i);
			/*button_binding*/ ctx[43](button);

			if (!mounted) {
				dispose = [
					listen(button, "blur", /*handleBlur*/ ctx[26]),
...
function create_else_block_1(ctx) {
	let li;
	let div;
	let t0_value = (/*item*/ ctx[92].display_text || /*item*/ ctx[92].text) + "";
	let t0;
	let t1;
	let t2;
	...
	let mounted;
	let dispose;
	let if_block = /*item*/ ctx[92].desc && create_if_block_7(ctx);
	...
	return {
		c() {
			...
			attr(li, "data-index", li_data_index_value = /*index*/ ctx[94]);
			attr(li, "id", li_id_value = "" + (/*containerId*/ ctx[11] + "_item_" + /*index*/ ctx[94]));
		},
		m(target, anchor) {
		...
		p(ctx, dirty) {
			if (dirty[0] & /*items*/ 32768 && t0_value !== (t0_value = (/*item*/ ctx[92].display_text || /*item*/ ctx[92].text) + "")) set_data(t0, t0_value);
			...
			if (dirty[0] & /*containerId*/ 2048 && li_id_value !== (li_id_value = "" + (/*containerId*/ ctx[11] + "_item_" + /*index*/ ctx[94]))) {
...
function create_if_block_5(ctx) {
	...
	let t1;
	let t2;
	let if_block = /*item*/ ctx[92].desc && create_if_block_6(ctx);
...
function create_if_block_7(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			if (dirty[0] & /*items*/ 32768 && t_value !== (t_value = /*item*/ ctx[92].desc + "")) set_data(t, t_value);
		},
		d(detaching) {
			if (detaching) detach(div);
		}
...
function create_each_block(ctx) {
	...
	function select_block_type(ctx, dirty) {
		if (/*item*/ ctx[92].separator) return create_if_block_4;
		if (/*item*/ ctx[92].disabled || /*item*/ ctx[92].placeholder) return create_if_block_5;
...
function create_if_block_1(ctx) {
	...
	return {
		c() {
			div = element("div");
			div.textContent = `${/*translate*/ ctx[25]("fetching")}`;
			attr(div, "class", "dropdown-item ts-item-muted ts-message-item");
		},
		m(target, anchor) {
			insert(target, div, anchor);
...
function create_fragment(ctx) {
	...
	function select_block_type_1(ctx, dirty) {
		if (/*fetchError*/ ctx[20]) return create_if_block;
		if (/*activeFetch*/ ctx[24] && !/*fetchingMore*/ ctx[19]) return create_if_block_1;
	...
	return {
		c() {
			...
			attr(input, "aria-expanded", /*popupVisible*/ ctx[21]);
			...
			attr(ul, "aria-expanded", /*popupVisible*/ ctx[21]);
			attr(ul, "aria-hidden", "false");
			attr(div1, "class", "ts-result");
			attr(div2, "class", "dropdown-menu ts-popup");
			attr(div2, "aria-hidden", div2_aria_hidden_value = !/*popupVisible*/ ctx[21]);
			attr(div2, "id", div2_id_value = "" + (/*containerId*/ ctx[11] + "_popup"));
			toggle_class(div2, "show", /*popupVisible*/ ctx[21]);
			toggle_class(div2, "ts-popup-fixed", /*popupFixed*/ ctx[4]);
			toggle_class(div2, "ts-popup-top", /*popupTop*/ ctx[22] && !/*popupFixed*/ ctx[4]);
			toggle_class(div2, "ts-popup-left", /*popupLeft*/ ctx[23] && !/*popupFixed*/ ctx[4]);
			toggle_class(div2, "ts-popup-fixed-top", /*popupTop*/ ctx[22] && /*popupFixed*/ ctx[4]);
			toggle_class(div2, "ts-popup-fixed-left", /*popupLeft*/ ctx[23] && /*popupFixed*/ ctx[4]);
		...
		m(target, anchor) {
			...
			if (!mounted) {
				dispose = [
					listen(window_1, "scroll", /*handleWindowScroll*/ ctx[34]),
					listen(input, "input", /*input_input_handler*/ ctx[42]),
					listen(input, "blur", /*handleBlur*/ ctx[26]),
					...
					listen(div1, "scroll", /*handleResultScroll*/ ctx[33])
				];
		...
		p(ctx, dirty) {
			...
			if (dirty[0] & /*popupVisible*/ 2097152 && div2_aria_hidden_value !== (div2_aria_hidden_value = !/*popupVisible*/ ctx[21])) {
			...
			if (dirty[0] & /*popupTop, popupFixed*/ 4194320) {
				toggle_class(div2, "ts-popup-top", /*popupTop*/ ctx[22] && !/*popupFixed*/ ctx[4]);
			}

			if (dirty[0] & /*popupLeft, popupFixed*/ 8388624) {
				toggle_class(div2, "ts-popup-left", /*popupLeft*/ ctx[23] && !/*popupFixed*/ ctx[4]);
			}
...
function instance($$self, $$props, $$invalidate) {
	...
	function setupComponent() {
		...
		$$invalidate(35, queryMinLen = ds.tsQueryMinLen !== undefined
		? parseInt(ds.tsQueryMinLen, 10)
		: queryMinLen);

		$$invalidate(1, query = ds.tsQuery !== undefined ? ds.tsQuery : query);

		$$invalidate(36, delay = ds.tsDelay !== undefined
	...
	$$self.$$.update = () => {
		if ($$self.$$.dirty[0] & /*query*/ 2 | $$self.$$.dirty[1] & /*selectedItem*/ 8388608) {
			////////////////////////////////////////////////////////////
			// HANDLERS
			//
			 {
