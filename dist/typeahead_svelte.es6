...
function create_else_block_1(ctx) {
	let li;
	let div;
	let t0_value = (/*item*/ ctx[93].display_text || /*item*/ ctx[93].text) + "";
	let t0;
	let t1;
	let t2;
	...
	let mounted;
	let dispose;
	let if_block = /*item*/ ctx[93].desc && create_if_block_7(ctx);
	...
	return {
		c() {
			...
			attr(li, "data-index", li_data_index_value = /*index*/ ctx[95]);
			attr(li, "id", li_id_value = "" + (/*containerId*/ ctx[11] + "_item_" + /*index*/ ctx[95]));
		},
		m(target, anchor) {
		...
		p(ctx, dirty) {
			if (dirty[0] & /*items*/ 32768 && t0_value !== (t0_value = (/*item*/ ctx[93].display_text || /*item*/ ctx[93].text) + "")) set_data(t0, t0_value);
			...
			if (dirty[0] & /*containerId*/ 2048 && li_id_value !== (li_id_value = "" + (/*containerId*/ ctx[11] + "_item_" + /*index*/ ctx[95]))) {
...
function create_if_block_5(ctx) {
	...
	let t1;
	let t2;
	let if_block = /*item*/ ctx[93].desc && create_if_block_6(ctx);
...
function create_if_block_7(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			if (dirty[0] & /*items*/ 32768 && t_value !== (t_value = /*item*/ ctx[93].desc + "")) set_data(t, t_value);
		},
		d(detaching) {
			if (detaching) detach(div);
		}
...
function create_each_block(ctx) {
	...
	function select_block_type(ctx, dirty) {
		if (/*item*/ ctx[93].separator) return create_if_block_4;
		if (/*item*/ ctx[93].disabled || /*item*/ ctx[93].placeholder) return create_if_block_5;
...
function instance($$self, $$props, $$invalidate) {
	...
	function setupComponent() {
		...
		$$invalidate(34, queryMinLen = ds.tsQueryMinLen !== undefined
		? parseInt(ds.tsQueryMinLen, 10)
		: queryMinLen);

		$$invalidate(1, query = ds.tsQuery !== undefined ? ds.tsQuery : query);

		$$invalidate(35, delay = ds.tsDelay !== undefined
