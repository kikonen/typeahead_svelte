...
function create_fragment(ctx) {
	...
	return {
		...
		m(target, anchor) {
			...
			/*ul_binding*/ ctx[77](ul);
			/*div1_binding*/ ctx[78](div1);
			append(div2, t2);
			if (if_block1) if_block1.m(div2, null);
			/*div2_binding*/ ctx[79](div2);
			/*div3_binding*/ ctx[80](div3);
		...
		d(detaching) {
			...
			/*div2_binding*/ ctx[79](null);
			/*div3_binding*/ ctx[80](null);
			mounted = false;
			run_all(dispose);
		}
	};
...
function instance($$self, $$props, $$invalidate) {
	...
	$$self.$$.update = () => {
		if ($$self.$$.dirty[0] & /*query*/ 2 | $$self.$$.dirty[1] & /*selectedItem*/ 131072) {
			////////////////////////////////////////////////////////////
			// HANDLERS
			//
			 {
