...
/* src/typeahead.svelte generated by Svelte v3.18.1 */
...
function create_else_block_1(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			if (dirty[0] & /*handleItemKeydown, items, handleBlur, handleItemClick, handleItemKeyup*/ 58851456) {
...
// (669:6) {#each items as item, index}
