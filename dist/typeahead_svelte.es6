...
/* src/typeahead.svelte generated by Svelte v3.23.0 */
...
function create_if_block_8(ctx) {
	...
	return {
		c() {
			...
			span = element("span");
			span.textContent = `${/*translate*/ ctx[20]("toggle")}`;
			t1 = space();
			i = element("i");
...
function create_else_block_1(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			if (dirty[0] & /*handleItemKeydown, items, handleBlur, handleItemClick, handleItemKeyup*/ 941623296) {
...
function create_if_block_2(ctx) {
	...
	function select_block_type_1(ctx, dirty) {
		if (/*tooShort*/ ctx[13]) return create_if_block_3;
...
function create_if_block_1(ctx) {
	...
	return {
		c() {
			div = element("div");
			div.textContent = `${/*translate*/ ctx[20]("fetching")}`;
			attr(div, "tabindex", "-1");
			attr(div, "class", "dropdown-item ts-item-info");
		},
		m(target, anchor) {
...
function create_else_block_2(ctx) {
	let div1;
	let div0;
	let t0_value = (/*item*/ ctx[68].display_text || /*item*/ ctx[68].text) + "";
	let t0;
	let t1;
	let t2;
	...
	let mounted;
	let dispose;
	let if_block = /*item*/ ctx[68].desc && create_if_block_7(ctx);
	...
	return {
		c() {
			...
			attr(div1, "data-index", div1_data_index_value = /*index*/ ctx[70]);
		},
		m(target, anchor) {
			...
			if (!mounted) {
				dispose = [
					listen(div1, "blur", /*handleBlur*/ ctx[21]),
		...
		p(ctx, dirty) {
			if (dirty[0] & /*items*/ 2048 && t0_value !== (t0_value = (/*item*/ ctx[68].display_text || /*item*/ ctx[68].text) + "")) set_data(t0, t0_value);
...
function create_if_block_5(ctx) {
	...
	let mounted;
	let dispose;
	let if_block = /*item*/ ctx[68].desc && create_if_block_6(ctx);
...
function create_if_block_4(ctx) {
	...
	return {
		c() {
			...
			attr(div, "data-index", div_data_index_value = /*index*/ ctx[70]);
		},
		m(target, anchor) {
			insert(target, div, anchor);
...
function create_if_block_7(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			if (dirty[0] & /*items*/ 2048 && t_value !== (t_value = /*item*/ ctx[68].desc + "")) set_data(t, t_value);
		},
		d(detaching) {
			if (detaching) detach(div);
		}
...
function create_each_block(ctx) {
	...
	function select_block_type_2(ctx, dirty) {
		if (/*item*/ ctx[68].separator) return create_if_block_4;
		if (/*item*/ ctx[68].disabled || /*item*/ ctx[68].placeholder) return create_if_block_5;
...
function create_fragment(ctx) {
	...
	function select_block_type(ctx, dirty) {
		if (/*fetchError*/ ctx[15]) return create_if_block;
		if (/*activeFetch*/ ctx[19] && !/*fetchingMore*/ ctx[14]) return create_if_block_1;
		if (/*actualCount*/ ctx[12] === 0) return create_if_block_2;
	...
	return {
		c() {
			...
			attr(div1, "tabindex", "-1");
			toggle_class(div1, "show", /*popupVisible*/ ctx[16]);
			toggle_class(div1, "ss-popup-top", /*popupTop*/ ctx[17]);
			toggle_class(div1, "ss-popup-left", /*popupLeft*/ ctx[18]);
		...
		m(target, anchor) {
			...
			/*div2_binding*/ ctx[67](div2);

			if (!mounted) {
				dispose = [
					listen(input, "input", /*input_input_handler*/ ctx[64]),
					listen(input, "blur", /*handleBlur*/ ctx[21]),
					...
					listen(div1, "scroll", /*handlePopupScroll*/ ctx[30])
				];
...
function instance($$self, $$props, $$invalidate) {
	...
	function fetchItems(fetchMore) {
		...
		if (fetchMore) {
			...
			$$invalidate(14, fetchingMore = true);
		} else {
			$$invalidate(11, items = []);
			offsetCount = 0;
			$$invalidate(12, actualCount = 0);
			hasMore = false;
			fetched = false;
	...
	function openPopup() {
		if (!popupVisible) {
			...
			$$invalidate(17, popupTop = bounds.y > middleY);
			$$invalidate(18, popupLeft = bounds.x + bounds.width > middleX);
		}
	}
	...
	function selectItem(el) {
		...
		if (item) {
			$$invalidate(41, selectedItem = item);
	...
	let inputKeypressHandlers = {
		base(event) {
			$$invalidate(41, selectedItem = null);
		}
	};
	...
	$$self.$set = $$props => {
		...
		if ("translations" in $$props) $$invalidate(33, translations = $$props.translations);
		if ("styles" in $$props) $$invalidate(2, styles = $$props.styles);
		if ("showToggle" in $$props) $$invalidate(3, showToggle = $$props.showToggle);
		if ("passEnter" in $$props) $$invalidate(34, passEnter = $$props.passEnter);
	};

	$$self.$$.update = () => {
		if ($$self.$$.dirty[0] & /*query*/ 2 | $$self.$$.dirty[1] & /*selectedItem*/ 1024) {
			////////////////////////////////////////////////////////////
			// HANDLERS
			//
			 {
